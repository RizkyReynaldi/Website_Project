...
if (isset($_POST['tambah_admin'])) {
    ...
    $result_tambah_admin = $db->Tambah_admin($username,$secure_pass);

    if ($result_tambah_admin == 1) {
        ...
        <div class="content">
            ...
            <div class="col-sm-12 col-xl-8">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Masukkan Data Admin</h6>
                            <form action="" method="post">
                                ...
                                <input type="submit" value="Tambah Admin" name="tambah_admin" class="btn btn-primary"></>
                            </form>
                        </div>
                    </div>
